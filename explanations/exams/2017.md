...
print f9([1, 1, 7, 7, 7, 3, 3, 3, 4, 4, 5, 5], 3)
```
...
print f11({"Klaas":18,"Remco":19, "Maria":20, "Lea":18}, 18)
```
...
print f13([], "abc", 3)
print f13(["ab", "abc", "abcd", "abcde"], "ab", 4)
```
